...
public class ScifioFormatExtensionHandler {
	   private static final NodeLogger LOGGER = NodeLogger
	            .getLogger(ScifioFormatExtensionHandler.class);

	    private ScifioFormatExtensionHandler() {
	        // utility class
	    }

	    /** The id of the IFormatReaderExtPoint extension point. */
	    public static final String EXT_POINT_ID = "org.knime.knip.io2.ScifioFormat";
