package org.knime.knip.nio.omero.port;
...
public class OmeroConnectionInformationPortObjectSpec extends ConnectionInformationPortObjectSpec {
    ...
    public static final class Serializer extends
            AbstractSimplePortObjectSpecSerializer<OmeroConnectionInformationPortObjectSpec> {
    }
     ...
     *
     *
     * @param omeroConnectionInfo
     *            The content of this port object
     */
    public OmeroConnectionInformationPortObjectSpec(
            final OmeroConnectionInformation omeroConnectionInfo) {
    ...
    public boolean equals(final Object ospec) {
        ...
        final OmeroConnectionInformationPortObjectSpec oCIPOS =
                (OmeroConnectionInformationPortObjectSpec) ospec;
